...
/**
 * Memoized particle system to prevent unnecessary re-renders within the Fiber loop.
 */
...
export default function ThreeHero() {
    ...
    // Performance: Only run the animation loop when the hero is visible to save GPU/CPU cycles
    useEffect(() => {
    ...
    return (
        <div ref={containerRef} className="absolute inset-0 z-0 bg-primary">
            ...
            <div className="absolute inset-0 z-10 w-full h-full opacity-80">
                {/* Performance:
                    1. frameloop is set to 'never' when not visible to idle the GPU.
                    2. dpr is capped at [1, 2] to prevent performance degradation on ultra-high-DPI screens.
                */}
                <Canvas

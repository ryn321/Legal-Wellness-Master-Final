...
// Performance: Memoize GoldenParticles to prevent unnecessary re-renders during frameloop transitions
...
export default function ThreeHero() {
    ...
    // Performance: Toggle frameloop based on visibility to save GPU resources
    useEffect(() => {
        ...
        <div ref={containerRef} className="absolute inset-0 z-0 bg-primary">
            ...
            <div className="absolute inset-0 z-10 w-full h-full opacity-80">
                <Canvas
                    ...
                    frameloop={isVisible ? 'always' : 'never'} // Performance: Idle GPU when out of view
                >
